...
/**
 * Class Humm_HummPayments_Model_Paymentmethod
 *
 * overrides basic payment method functionality and visuals
 */
class Humm_HummPayments_Model_Paymentmethod extends Mage_Payment_Model_Method_Abstract {
    protected $_code = 'HummPayments';
    protected $_formBlockType = 'HummPayments/form_HummPayments';
    protected $_infoBlockType = 'HummPayments/info_HummPayments';
    ...
    public function refund( Varien_Object $payment, $amount ) {
        $url = Humm_HummPayments_Helper_Data::getRefundUrl();
        ...
        $refund_signature            = Humm_HummPayments_Helper_Crypto::generateSignature( $refund_details, $apiKey );
